...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <div class="content">
        <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gorev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form action="<?php echo e(route('taskUpdate', ['id' => $gorev->id])); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="form-group">
                        <label>Görev Türü</label>
                        <input type="text" class="form-control" name="task_type" value="<?php echo e($gorev->task_type); ?>">
                    </div>
                    <div class="form-group">
                        <label>Görev Açıklaması</label>
                        <input type="text" class="form-control" name="task_description" value="<?php echo e($gorev->task_description); ?>"></input>
                    </div>
                    <div class="form-group">
                        <label>Görev Başlangıç Tarihi</label>
                        <input type="date" class="form-control" name="task_start_date" value="<?php echo e($gorev->task_start_date); ?>">
                    </div>
                    <div class="form-group">
                        <label>Görev Bitiş Tarihi (isteğe bağlı)</label>
                        <input type="date" class="form-control" name="task_end_date" value="<?php echo e($gorev->task_end_date); ?>">
                    </div>
                    <div class="form-group">
                        <label>Görev İlerleyiş</label>
                        <input type="range" min="0" max="100" class="form-control" name="task_progress" value="<?php echo e($gorev->task_progress); ?>">
                    </div>
                    <div class="form-group">
                        <label>Görev Durum</label>
                        <select name="task_status" class="form-control" $value="<?php echo e($gorev->task_status); ?>">
