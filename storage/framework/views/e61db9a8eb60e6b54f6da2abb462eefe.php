...
<div class="login-box">
  ...
  <?php if($errors->any()): ?>
    ...
    <div class="card-body login-card-body">
      ...
      <a href="<?php echo e(route('register_')); ?>" type="submit" name="register" class="btn btn-primary btn-block">Kayıt Ol</a>
  </div>
</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\benimprojem2\resources\views/blogs/login.blade.php ENDPATH**/ ?>