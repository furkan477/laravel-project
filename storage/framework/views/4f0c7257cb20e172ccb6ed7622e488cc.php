...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo e(route('r_success')); ?>  " method="post">
        <?php echo csrf_field(); ?>
      ...
      <a href="<?php echo e(route('login')); ?>" type="submit" name="login" class="btn btn-primary btn-block">Giriş Yap</a>

  </div>
</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\benimprojem\resources\views/register.blade.php ENDPATH**/ ?>