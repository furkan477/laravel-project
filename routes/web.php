...
Route::post('/register',[FormController::class,'register_success'])->name('r_success')->middleware('unique.email');
...
Route::get('/logout',[FormController::class,'logout'])->name('logout')->middleware('auth.custom');
